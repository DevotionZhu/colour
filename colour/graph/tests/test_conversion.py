...
from colour.characterisation import SDS_COLOURCHECKER
...
class TestConvert(unittest.TestCase):
    ...
    def test_convert(self):
        ...
        RGB_a = convert(SDS_COLOURCHECKER['ColorChecker N Ohta']['dark skin'],
    ...
    def test_convert_direct_keyword_argument_passing(self):
        ...
        if six.PY3:  # pragma: no cover
            ...
            self.assertRaises(AttributeError, lambda: convert(
                SDS_COLOURCHECKER['ColorChecker N Ohta']['dark skin'],
                'Spectral Distribution', 'sRGB',
