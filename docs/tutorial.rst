...
.. code:: python
    ...
    print(sorted(colour.characterisation.CHROMATICITIES_COLOURCHECKER.keys()))

    # Colour rendition charts spectral distributions.
    print(sorted(colour.characterisation.SDS_COLOURCHECKER.keys()))
...
.. code:: python
    ...
    patch_sd = colour.SDS_COLOURCHECKER['ColorChecker N Ohta'][patch_name]
